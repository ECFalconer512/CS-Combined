...
public class UofUStudent {
	 ...
	 * @return true if the other object is a assign02.UofUStudent type and is equal to this student,
	 *         false otherwise
	 */
	public boolean equals(Object other) {		
		// FILL IN -- do not return false unless appropriate
		// Will return true is first name, last name, and uNID are all the same
		if (other instanceof UofUStudent==false){
			return false;
		}
		// Sets the first and last name, and uNID of other student to variables
		String otherFirstName=((UofUStudent) other).getFirstName();
		String otherLastName=((UofUStudent) other).getLastName();
		int otherUNID=((UofUStudent) other).getUNID();

		// creates boolean variables for whether each aspect of the other student
		// equals the aspects of this student
		boolean firstNameState=firstName.equals(otherFirstName);
		boolean lastNameState=lastName.equals(otherLastName);
		boolean uNIDState=(uNID==otherUNID);

		if (firstNameState&&lastNameState&&uNIDState){
			return true;
		}
		return false;
	}
