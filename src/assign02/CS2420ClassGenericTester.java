 ...
 * 
 * @author Erin Parker, Ben Jones and Evan Falconer
...
public class CS2420ClassGenericTester {
	...
	public void testEmptyLookupUNID() {
		Assertions.assertNull(emptyClass.lookup(1234567));
	}
	...
	public void testAddScoreFail(){
		CS2420StudentGeneric<MailingAddress> student= verySmallClass.lookup(2323232);
		student.addScore(2, "nah");
		student.addScore(120, "assignment");
		student.addScore(-1, "exam");
		student.addScore(-5, "lab");
		student.addScore(150, "quiz");
		Assertions.assertEquals(0,student.computeFinalScore());
	}
	...
	public void testLargeLookupContactInfo() {
		...
		Assertions.assertEquals(100, actualStudents.size());
	}
	...
	public void testLargeGetContactList() {
		...
		Assertions.assertTrue(actual.contains(new PhoneNumber("801-555-1234")));
		Assertions.assertTrue(actual.contains(new PhoneNumber("801-555-5678")));
		Assertions.assertTrue(actual.contains(new PhoneNumber("801-555-9012")));
		Assertions.assertTrue(actual.contains(new PhoneNumber("801-555-3456")));
		Assertions.assertTrue(actual.contains(new PhoneNumber("801-555-7890")));
	}
