...
public class CS2420Class {
	...
	public ArrayList<CS2420Student> lookup(EmailAddress contactInfo) {
		...
		ArrayList<CS2420Student> sameContact= new ArrayList<CS2420Student>();
		for (CS2420Student s: studentList){
	...
	public void addScore(int uNID, double score, String category) {
		...
		CS2420Student targetStudent=lookup(uNID);
	...
	public ArrayList<EmailAddress> getContactList() {
		//creates two lists to help remove duplicates
		ArrayList<EmailAddress> dupesContactList= new ArrayList<EmailAddress>();
		ArrayList<EmailAddress> noDupesContactList= new ArrayList<EmailAddress>();
		for(CS2420Student s: studentList){
			dupesContactList.add(s.getContactInfo());
		}
		boolean noDupes;
		for(EmailAddress e: dupesContactList){
			noDupes=true;
			for(EmailAddress a: noDupesContactList){
				if(e.equals(a)){
					noDupes=false;
					break;
				}
	 ...
	 * @return the assign02.CS2420Student constructed from the information
